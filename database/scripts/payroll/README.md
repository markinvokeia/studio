...
| `payroll_retentions` | Retenciones del empleado (BHU/ANV, caja profesional, alimentos, alquiler…); alimentan el crédito de IRPF. Antes `payroll_irpf_deductions`, renombrada en `010` |
