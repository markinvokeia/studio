-- =====================================================================
-- Users — flag can_browse_calendars
-- Habilita por doctor la posibilidad de ver, en su workspace, las citas
-- de los calendarios a los que tiene acceso (además de las asignadas a él).
...
ALTER TABLE public.users
    ADD COLUMN IF NOT EXISTS can_browse_calendars boolean NOT NULL DEFAULT false;

-- -----------------------------------------------------------------------
-- get_users_filtered — agregar can_browse_calendars al RETURNS TABLE y SELECT.
-- Se hace DROP + CREATE porque cambiar el tipo de retorno no es posible con
-- CREATE OR REPLACE.
-- -----------------------------------------------------------------------
...
BEGIN
    ...
    SELECT
        ...
        u.can_browse_calendars, -- <-- NUEVA COLUMNA, MISMO ORDEN QUE EN RETURNS TABLE
...
VALUES (
    '053_20260625_users-can-browse-calendars.sql',
    'v1',
    'Users — columna can_browse_calendars (flag por doctor para ver agendas de calendarios)'
)
