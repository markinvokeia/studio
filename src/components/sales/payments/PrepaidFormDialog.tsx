...
export interface PrepaidFormDialogProps {
    open: boolean;
...
export function PrepaidFormDialog({ open, onOpenChange, initialUser, onSaveSuccess }: PrepaidFormDialogProps) {
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
                            <DialogBody className="space-y-4 px-6 py-4">
                                ...
                                {/* Client field — locked if pre-filled */}
                                            ...
                                            <Popover open={isUserPopoverOpen} onOpenChange={setIsUserPopoverOpen}>
                                                ...
                                                <PopoverContent className="w-[--radix-popover-trigger-width] p-0">
                                                    <Command shouldFilter={false}>
                                                        <CommandInput placeholder={t('prepaidDialog.searchClient')} value={userSearchTerm} onValueChange={setUserSearchTerm} />
                                                        <CommandList>
                                                            {isLoadingUsers ? (
