          ...
          <tbody>
            {assignments.map((sa) => (
              ...
              >
                ...
                <td className="px-3 py-1.5 font-mono text-muted-foreground">{formatDate(sa.session_date)}</td>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs font-mono text-muted-foreground">{formatDate(sa.session_date)}</span>
