...
import { ALERT_CENTER_PERMISSIONS, BUSINESS_CONFIG_PERMISSIONS, CASHIER_PERMISSIONS, CLINIC_CATALOG_PERMISSIONS, DASHBOARD_PERMISSIONS, DICOM_PERMISSIONS, LICENSING_PERMISSIONS, MEDICAL_HISTORY_PERMISSIONS, PATIENTS_PERMISSIONS, PAYROLL_PERMISSIONS, PURCHASES_PERMISSIONS, REPORTS_PERMISSIONS, SALES_PERMISSIONS, SUBSCRIPTIONS_PERMISSIONS, SYSTEM_PERMISSIONS, TV_DISPLAY_PERMISSIONS } from '@/constants/permissions';
...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    href: '/payroll/portal',
    icon: UserCheck,
    requiredPermission: PAYROLL_PERMISSIONS.PORTAL_VIEW,
  },
  {
    title: 'AlertsCenter',
    href: '/alerts',
  ...
  },
  {
    ...
    items: [
      { title: 'PayrollDashboard',  href: '/payroll/dashboard',  icon: LayoutDashboard, isChidren: true, requiredPermission: PAYROLL_PERMISSIONS.DASHBOARD_VIEW },
      ...
      { title: 'PayrollLicencias',  href: '/payroll/licencias',  icon: ClipboardList,   isChidren: true, requiredPermission: PAYROLL_PERMISSIONS.NOVEDADES_VIEW },
      ...
      { title: 'PayrollReports',    href: '/payroll/reports',    icon: BarChart2,       isChidren: true, requiredPermission: PAYROLL_PERMISSIONS.REPORTS_VIEW },
      { title: 'PayrollSettings',   href: '/payroll/settings',   icon: Settings,        isChidren: true, requiredPermission: PAYROLL_PERMISSIONS.SETTINGS_VIEW },
      // PayrollPortal is surfaced as a top-level nav item near DoctorWorkspace
    ],
  },
  {
    title: 'ClinicCatalog',
  ...
  {
    title: 'Reports',
    href: '/reports/cierre-caja',
    icon: BarChart2,
    requiredPermission: REPORTS_PERMISSIONS.VIEW_MENU,
    items: [
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportCierreCaja',    href: '/reports/cierre-caja',            icon: Vault,             isChidren: true, requiredPermission: REPORTS_PERMISSIONS.CAJA_VIEW },
      { title: 'ReportCobrosDia',     href: '/reports/cobros-dia',             icon: CircleDollarSign,  isChidren: true, requiredPermission: REPORTS_PERMISSIONS.CAJA_VIEW },
      { title: 'ReportCuentasCtes',   href: '/reports/cuentas-corrientes',     icon: AlertTriangle,     isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: 'ReportPresupuestos',  href: '/reports/estado-presupuestos',icon: FileText,          isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportProduccionDoc', href: '/reports/produccion-doctor',      icon: Stethoscope,       isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PRODUCCION_VIEW },
      { title: 'ReportTratamientos',  href: '/reports/tratamientos',           icon: Activity,          isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PRODUCCION_VIEW },
      { title: 'ReportComparativo',   href: '/reports/comparativo-produccion', icon: TrendingUp,        isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PRODUCCION_VIEW },
      { title: 'ReportHonorarios',    href: '/reports/honorarios',             icon: Banknote,          isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PRODUCCION_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportNuevosPx',      href: '/reports/nuevos-pacientes',       icon: UserPlus,          isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PACIENTES_VIEW },
      { title: 'ReportInactivosPx',   href: '/reports/pacientes-inactivos',    icon: UserX,             isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PACIENTES_VIEW },
      { title: 'ReportTratCurso',     href: '/reports/tratamientos-en-curso',  icon: ClipboardList,     isChidren: true, requiredPermission: REPORTS_PERMISSIONS.PACIENTES_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportOcupacion',     href: '/reports/ocupacion-agenda',       icon: CalendarDays,      isChidren: true, requiredPermission: REPORTS_PERMISSIONS.AGENDA_VIEW },
      { title: 'ReportCancelaciones', href: '/reports/cancelaciones',          icon: CalendarX,         isChidren: true, requiredPermission: REPORTS_PERMISSIONS.AGENDA_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportIngPeriodo',    href: '/reports/ingresos-periodo',       icon: TrendingUp,        isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: 'ReportFactCobranza',  href: '/reports/facturacion-cobranza',   icon: Scale,             isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: 'ReportDeudores',      href: '/reports/deudores',               icon: AlertCircle,       isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: 'ReportServicios',      href: '/reports/servicios',              icon: PieChart,          isChidren: true, requiredPermission: REPORTS_PERMISSIONS.INGRESOS_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
      { title: 'ReportGastos',        href: '/reports/gastos-operativos',      icon: Receipt,           isChidren: true, requiredPermission: REPORTS_PERMISSIONS.GASTOS_VIEW },
      { title: '', href: '', icon: BarChart2, isSeparator: true },
