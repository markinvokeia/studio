...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    requiredAnyPermission: [
      ...
      BUSINESS_CONFIG_PERMISSIONS.PROVIDER_GROUPS_VIEW_MENU,
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Customizations', href: '/system/customizations', icon: Puzzle, isChidren: true, requiredPermission: SYSTEM_PERMISSIONS.CUSTOMIZATIONS_VIEW_MENU },
