...
async function upsertPaymentMethod(data: PaymentMethodFormValues) {
    const response = await fetch('https://n8n-project-n8n.7ig1i3.easypanel.host/webhook/metodospago/upsert', {
        method: 'POST',
...
async function deletePaymentMethod(id: string) {
    const response = await fetch('https://n8n-project-n8n.7ig1i3.easypanel.host/webhook/metodospago/delete', {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
