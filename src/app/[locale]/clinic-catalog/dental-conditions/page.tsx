                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 ml-2 flex-none">
                        ...
                        {selectedCondition && !isEditing && canDelete && (
                            <Button aria-label={tColumns('delete')} variant="ghost" size="icon" className="h-8 w-8 hover:bg-destructive/10 hover:text-destructive" onClick={() => { setDeletingCondition(selectedCondition); setIsDeleteDialogOpen(true); }}>
