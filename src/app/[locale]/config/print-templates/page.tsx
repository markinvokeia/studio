...
function substituteForPreview(
  ...
  const sampleMovementsTable = `<div style="margin-bottom:1.5rem;"><h2 style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:#6b7280;margin-bottom:0.5rem;">Moneda: UYU</h2><div style="border:1px solid #e5e7eb;border-radius:4px;"><table class="print-template-table" style="width:100%;"><thead><tr><th style="text-align:left;width:6rem;">Fecha</th><th style="text-align:left;width:8rem;">Nro. Doc.</th><th style="text-align:left;">Concepto</th><th style="text-align:right;width:7rem;">Monto</th><th style="text-align:right;width:7rem;">Saldo</th></tr></thead><tbody><tr><td>28/05/2026</td><td style="font-family:monospace;font-size:0.72rem;">FAC-0021</td><td>Factura — Extracción simple</td><td style="text-align:right;font-family:monospace;">UYU 500</td><td style="text-align:right;font-family:monospace;">UYU 500</td></tr><tr><td>28/05/2026</td><td style="font-family:monospace;font-size:0.72rem;">PAG-0042</td><td>Recibo de Pago — Efectivo</td><td style="text-align:right;font-family:monospace;">−UYU 500</td><td style="text-align:right;font-family:monospace;">UYU 0</td></tr></tbody><tfoot><tr style="border-top:2px solid #d1d5db;"><td colspan="4" style="text-align:right;font-weight:600;">Saldo Final</td><td style="text-align:right;font-weight:700;font-family:monospace;">UYU 0</td></tr></tfoot></table></div></div>`;
